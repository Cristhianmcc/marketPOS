...
// ✅ MÓDULO 17.3: Panel del carrito con header/footer fijo para desktop/tablet
'use client';
              ...
              >
                ...
                {hasDiscount && (
                  <div className="mb-2 space-y-1">
                    ...
                    {item.nthPromoName && (
                      <div className="flex items-center gap-1 text-xs text-pink-600 bg-pink-50 px-2 py-0.5 rounded">
                        <Tag className="w-3 h-3" />
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      onClick={() => onUpdateQuantity(item.storeProduct.id, 1)}
                      className="w-8 h-8 flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 text-white rounded transition-colors"
                    >
                ...
                {!item.discountType && (
                  <button
                    ...
                    className="w-full mt-2 py-1.5 text-xs text-emerald-600 hover:bg-emerald-50 rounded transition-colors"
                  >
                    + Aplicar descuento
                  </button>
                )}
      ...
      {cart.length > 0 && (
        <div className="border-t bg-gray-50 p-4 space-y-3 shrink-0">
          ...
          <button
            ...
            className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold rounded-lg transition-colors text-base shadow-md"
          >
